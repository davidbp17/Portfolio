...
class Timit:
    ...
    def __init__(self, basedir):
        ...
        for datatype in ('train', 'test'):
            self.corpusdir[datatype] = dict()
            for gender in ('woman', 'man'):
                self.corpusdir[datatype][gender] = os.path.join(basedir, datatype, gender)
    ...
    def get_filenames(self, type, gender, ext='.wav'):
        """
        ...
        dir = self.corpusdir[type][gender]
